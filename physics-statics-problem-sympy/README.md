...
$\displaystyle A_{x} = \frac{l w}{\sqrt{- d^{2} + l_{c}^{2}}}$



$\displaystyle A_{y} = w + \frac{l w}{d}$



$\displaystyle T = \frac{l l_{c} w}{d \sqrt{- d^{2} + l_{c}^{2}}}$
...
$\displaystyle A_{x} - 0.181818181818182 T d = 0$



$\displaystyle A_{y} - 1.0 T \sqrt{1 - 0.0330578512396694 d^{2}} - 200 = 0$



$\displaystyle 1.0 T d \sqrt{1 - 0.0330578512396694 d^{2}} - 2000 = 0$
...
$\displaystyle A_{x} = \frac{363.636363636364}{\sqrt{1 - 0.0330578512396694 d^{2}}}$



$\displaystyle A_{y} = 200.0 + \frac{2000.0}{d}$



$\displaystyle T = \frac{2000.0}{d \sqrt{1 - 0.0330578512396694 d^{2}}}$
...
$\displaystyle A = 2000.0 \sqrt{\left(0.1 + \frac{1}{d}\right)^{2} + \frac{0.0330578512396694}{1 - 0.0330578512396694 d^{2}}}$
